...
public class App {
    ...
    private static void mostrarEmpleados() {
        List<EmpleadosJPAEntity> empleados = EmpleadoDAO.obtenerEmpleados();
        if (empleados.isEmpty()) {
            System.out.println("No hay empleados.");
        } else {
            for (EmpleadosJPAEntity empleado : empleados) {
    ...
    private static void mostrarDepartamentos() {
        List<DepartamentosJPAEntity> departamentos = DepartamentoDAO.obtenerDepartamentos();
        if (departamentos.isEmpty()) {
            System.out.println("No hay departamentos.");
        } else {
            for (DepartamentosJPAEntity departamento : departamentos) {
    ...
    private static void crearEmpleado() {
        ...
        EmpleadosJPAEntity nuevoEmpleado = new EmpleadosJPAEntity();
    ...
    private static void actualizarEmpleado() {
        ...
        EmpleadosJPAEntity empleado = EmpleadoDAO.obtenerEmpleadoPorId(idEmpleado);
        if (empleado != null) {
    ...
    private static void crearDepartamento() {
        ...
        DepartamentosJPAEntity nuevoDepartamento = new DepartamentosJPAEntity();
    ...
    private static void actualizarDepartamento() {
        ...
        DepartamentosJPAEntity departamento = DepartamentoDAO.obtenerDepartamentoPorId(idDepartamento);
