...
public class App {
    ...
    public static void main(String[] args) {
        ...
        List<Employee> employees = List.of(
                ...
                new Employee(null,"emp2","emp2@gmail.com", LocalDate.of(1980,1,1),false, 50000.0, LocalDate.of(1970,1,1), LocalDate.of(1980,1,1)),
                new Employee(null,"emp3","emp3@gmail.com", LocalDate.of(1973,1,1),true, 60000.0, LocalDate.of(1990,1,1), LocalDate.of(1994,1,1)),
                new Employee(null,"emp4","emp4@gmail.com", LocalDate.of(1973,1,1),false, 60000.0, LocalDate.of(1995,1,1), LocalDate.of(1994,1,1)),
        ...
        System.out.println("\nfindAllByBirthDate: 1985,1,1");
        repo.findAllByBirthDateAfter(LocalDate.of(1985,1,1)).forEach(System.out::println);

        System.out.println("\nfindAllByBirthDateQuery: 1985,1,1");
        repo.findAllByBirthDateAfterQuery(LocalDate.of(1985,1,1)).forEach(System.out::println);

        System.out.println("\nfindAllByInitAndEndDatesQuery: 1985,1,1");
        repo.findAllByInitAndEndDatesQuery(LocalDate.of(1993,1,1), LocalDate.of(1997,1,1)).forEach(System.out::println);
        ...
        System.out.println("\nfindNameAndEmailExcludingId");
        repo.findNameAndEmailExcludingId().forEach(System.out::println);
