...
public class AgenciasEntity {
    ...
    private Collection<DestinosAgenciasEntity> destinosAgenciasByAgenciaId;
    ...
    public Collection<DestinosAgenciasEntity> getDestinosAgenciasByAgenciaId() {
        return destinosAgenciasByAgenciaId;
    }

    public void setDestinosAgenciasByAgenciaId(Collection<DestinosAgenciasEntity> destinosAgenciasByAgenciaId) {
        this.destinosAgenciasByAgenciaId = destinosAgenciasByAgenciaId;
    }
}
