...
public class ClientesEntity {
    ...
    private Collection<ClientesDestinosEntity> clientesDestinosByClienteId;
    ...
    public Collection<ClientesDestinosEntity> getClientesDestinosByClienteId() {
        return clientesDestinosByClienteId;
    }

    public void setClientesDestinosByClienteId(Collection<ClientesDestinosEntity> clientesDestinosByClienteId) {
        this.clientesDestinosByClienteId = clientesDestinosByClienteId;
    }
}
